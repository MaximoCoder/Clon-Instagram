        ...
        <div class="md:w-4/12 bg-white shadow-xl rounded-lg p-6">
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input id="username" name="username" type="text" placeholder="Tu Nombre de usuario" class="border p-3 w-full rounded-lg @error('username') border-red-500 @enderror"
                    value="{{ old('username') }}"
                    >
                    <!-- Mensajes de error -->
                    @error('username')
                ...
                <div class="mb-5">
                    ...
                    <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Confirma tu password" class="border p-3 w-full rounded-lg">
                </div>
